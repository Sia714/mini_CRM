  ...
  try {
    ...
    await Promise.all(
      messages.map(async (msg) => {
        ...
        await axios.post(`${process.env.BACKEND_URL}/vendor/delivery-receipt`, {
...
router.post("/delivery-receipt", async (req, res) => {
  ...
  try {
    ...
    console.log(campaign.messageStatus);
    ...
    campaign.failedCount = campaign.messageStatus.length - campaign.sentCount;
